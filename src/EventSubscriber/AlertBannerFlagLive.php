...
/**
* @file
* Contains \Drupal\bhcc_alert_banners\EventSubscriber\AlertBannerFlagLive.
* @src
* https://dev.studiopresent.com/blog/back-end/perform-actions-flag-unflag-drupal-8
*/

namespace Drupal\bhcc_alert_banners\EventSubscriber;
...
class AlertBannerFlagLive implements EventSubscriberInterface {
  ...
  public function onFlag(FlaggingEvent $event) {
    ...
    if ($flagType == 'put_live') {
      ...
      // Regenerate JS token
      \Drupal::service('bhcc_alert_banners.state')->generateToken($flagging->getFlaggable())->save();
