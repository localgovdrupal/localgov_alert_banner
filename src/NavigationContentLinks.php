...
final class NavigationContentLinks implements ContainerInjectionInterface {
  ...
  public function addMenuLinks(array &$links): void {
    ...
    // array keys.
    $content_links = [
      'localgov_alert_banner.navigation.alert_banners' => [
        'route_name' => 'entity.localgov_alert_banner.collection',
        'title' => $this->t('Alert banners'),
        'weight' => 10,
      ],
    ];
    ...
    $this->addCreateEntityLinks('localgov_alert_banner_type', 'entity.localgov_alert_banner.add_form', $links);
